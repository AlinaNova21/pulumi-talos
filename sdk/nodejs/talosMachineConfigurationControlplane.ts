 ...
 * ```
 */
export class TalosMachineConfigurationControlplane extends pulumi.CustomResource {
    /**
     * Get an existing TalosMachineConfigurationControlplane resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TalosMachineConfigurationControlplaneState, opts?: pulumi.CustomResourceOptions): TalosMachineConfigurationControlplane {
        return new TalosMachineConfigurationControlplane(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'talos:index/talosMachineConfigurationControlplane:TalosMachineConfigurationControlplane';

    /**
     * Returns true if the given object is an instance of TalosMachineConfigurationControlplane.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TalosMachineConfigurationControlplane {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TalosMachineConfigurationControlplane.__pulumiType;
    }
    ...
    /**
     * Create a TalosMachineConfigurationControlplane resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TalosMachineConfigurationControlplaneArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TalosMachineConfigurationControlplaneArgs | TalosMachineConfigurationControlplaneState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TalosMachineConfigurationControlplaneState | undefined;
            ...
            const args = argsOrState as TalosMachineConfigurationControlplaneArgs | undefined;
        ...
        super(TalosMachineConfigurationControlplane.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface TalosMachineConfigurationControlplaneState {
    /**
     * The endpoint of the Talos cluster
     */
 ...
 */
export interface TalosMachineConfigurationControlplaneArgs {
    /**
     * The endpoint of the Talos cluster
     */
    clusterEndpoint: pulumi.Input<string>;
